...
figure_dir <- file.path("figures", sprintf("%s_agg", method), "summary", consensus)
cytominer_compare_dir <- file.path("figures", sprintf("%s_agg", method), "cytominer_comparison", consensus)
