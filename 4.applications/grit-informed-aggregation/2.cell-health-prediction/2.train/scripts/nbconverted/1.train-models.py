...
from scripts.ml_utils import load_train_test, CellHealthPredict #moved this into my folder and it works!
...
x_train_df, x_test_df, y_train_df, y_test_df = (
    load_train_test(data_dir=train_folder, drop_metadata=True, consensus=consensus)
)
x_meta_train_df, x_meta_test_df, y_meta_train_df, y_meta_test_df = (
    load_train_test(data_dir=train_folder, output_metadata_only=True, consensus=consensus)
)
