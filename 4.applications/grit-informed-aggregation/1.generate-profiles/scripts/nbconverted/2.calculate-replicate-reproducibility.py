...
pd.DataFrame(
    data={
        "Cell Line": cell_list,
        "Aggregation Method": method_list,
        "Guide Replicate Reproducibility": f_guide_cor_list,
        "Gene Replicate Reproducibility": f_gene_cor_list,
    }
).round(4)
...
box = (
    ...
    + gg.labs(
        ...
        y="Replicate Pearson Correlation",
...
].sort_values("Aggregation Method")
